package com.liguoxi.behaviors.behavior;
...
import com.liguoxi.behaviors.BaseActivity;
import com.liguoxi.behaviors.BottomSheetActivity;
import com.liguoxi.behaviors.R;
...
//            colorId = android.R.color.transparent;
            colorId = R.color.primaryTransparent;
        } else {
    ...
    private void showTitleInToolBar() {
        ...
        CharSequence title = ((BottomSheetActivity) mContext).getBottomTitle();
//
...
//        textViewFromToolbar.setX(initialLocation[0]);
    ...
    private void showBackgroundInStatusBar() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            Window w = ((BaseActivity) mContext).getWindow();
